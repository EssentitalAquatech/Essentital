...
export const addFarmer = async (req, res) => {
  try {
    ...
    // ❌ NO FARMER ID GENERATION HERE - MODEL WILL HANDLE IT AUTOMATICALLY
    console.log("✅ farmerId will be auto-generated by model");
    ...
    // ✅ CREATE FARMER WITHOUT MANUAL farmerId
    const newFarmer = new Farmer({
      // ❌ NO farmerId HERE - MODEL PRE-SAVE HOOK WILL GENERATE IT
      userId,
      createdBy: userId,
      name, 
      contact, 
