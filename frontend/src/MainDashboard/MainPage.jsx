...
const getFarmerImage = (farmer) => {
  ...
  // If photo already has full URL (from DB), use it directly
  if (farmer.photo.includes("http://") || farmer.photo.includes("https://")) {
    return farmer.photo;
  }
  
  // Otherwise use getImageUrl to construct proper URL
  return getImageUrl(farmer.photo);
};
  ...
  const renderExistingFiles = (list) => {
    ...
    return (
      <div style={{ marginTop: 6 }}>
        {list.map((fn, i) => (
          <div key={i}>
            <a target="_blank" rel="noreferrer" href={getFarmerImage({ photo: fn })}>
              {fn.split('/').pop()}
            </a>
          </div>
        ))}
    ...
    <div className="dashboard-container">
      ...
      {isMobile && (
        <div className="mobile-navbar">
          ...
          <div className="mobile-profile">
            <img
              src={photo !== "/profile.png" ? getImageUrl(photo) : "/profile.png"}
              alt="User"
              className="mobile-profile-pic"
              onError={(e) => {
                e.target.src = "/profile.png";
              ...
              <div className="row g-2">
                ...
                <div className="col-md-12">
                  ...
                  {newFarmer.photoExisting && (
                    <div style={{ marginTop: 6 }}>
                      <img
                        src={getFarmerImage({ photo: newFarmer.photoExisting })}
                        alt="Existing Farmer"
                        style={{ width: 80, height: 80, borderRadius: "50%" }}
                        onError={(e) => {
                          e.target.src = "/profile.png";
              ...
              <div className="modal-section">
                ...
                <div className="row g-2">
                  ...
                  <div className="col-md-6">
                    ...
                    />
                    {newPond.pondImageExisting && <div style={{ marginTop: 6 }}>
                      <a target="_blank" rel="noreferrer" href={getFarmerImage({ photo: newPond.pondImageExisting })}>
                        Existing: {newPond.pondImageExisting.split('/').pop()}
                      </a>
                    </div>}
                  </div>
