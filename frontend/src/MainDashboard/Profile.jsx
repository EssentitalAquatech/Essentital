...
//   // Reset sidebar on browser back/forward
//   useEffect(() => {
...
//         <ul className="profile-menu">
//           <li>
//             <Link to="/profile" className="profile-menu-btn active" onClick={closeSidebar}>
//               <User size={18} />  {t("profile")}
//             </Link>
//           </li>
//           <li>
//             <Link to="/dashboard" className="profile-menu-btn" onClick={closeSidebar}>
//              <Home size={18} />   {t("dashboard")}
//             </Link>
//           </li>
//           <li>
//             <Link to="/helpcenter" className="profile-menu-btn" onClick={closeSidebar}>
//            <HelpCircle size={18} />     {t("helpCenter")}
//             </Link>
//           </li>
//           <li>
//             <Link to="/dealers" className="profile-menu-btn" onClick={closeSidebar}>
//              <ShoppingBag size={18} />   {t("dealers")}
//             </Link>
//           </li>
//           <li>
//             <Link to="/agents" className="profile-menu-btn" onClick={closeSidebar}>
//            <Users size={18} />     {t("agents")}
//             </Link>
//           </li>
//         </ul>
...
//       {/* ================= RIGHT CONTENT ================= */}
//       <div className={`profile-content-area ${isMobile ? 'mobile-view' : ''} ${isSidebarOpen ? 'sidebar-open' : ''}`}>
