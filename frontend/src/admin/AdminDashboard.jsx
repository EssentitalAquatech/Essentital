...
//   const urls = pondFiles.map((file, index) => {
//     // CORRECTED URL: Use the pond.pondId (like FAR-2026-00002-P1)
//     const pondCode = selectedPond?.pondId || pondId;
//     const url = `${API_URL}/api/images/pond/file/${pondCode}/${index}`;
//     console.log(`✅ Pond file ${index} URL:`, url);
//     return url;
//   });
...
//     // CORRECTED URL: Use the pond.pondId (like FAR-2026-00002-P1)
//     const pondCode = selectedPond?.pondId || pondId;
//     const url = `${API_URL}/api/images/fish/file/${pondCode}/${index}`;
//     console.log(`✅ Fish file ${index} URL:`, url);
//     return url;
//   });
