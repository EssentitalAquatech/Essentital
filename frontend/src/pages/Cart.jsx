...
//         qty: item.quantity,
//         weight: item.weight || "1kg",
//         weightKg: weightOptions.find(w => w.label === item.weight)?.kg || 1
//       }));
...
//   const updateVariant = (index, newLabel) => {
//     const updatedCart = [...cart];
//     const item = updatedCart[index];
...
//                             key={variant.label}
//                             className={`cart-weight-btn ${
//                               item.variantLabel === variant.label ? "active" : ""
//                             }`}
//                             onClick={() => updateVariant(index, variant.label)}
//                           >
//                             {variant.label}
//                           </button>
//                         ))}
...
//                     <div className="price-display">
//                       <div className="price-row">
//                         <span>Price per {item.variantLabel}:</span>
//                         <span className="price-value">
//                           ₹ {item.price.toFixed(2)}
//                         </span>
//                       </div>
...
const Cart = () => {
  ...
  const placeOrder = async () => {
    ...
    try {
      // ✅ UPDATED: Changed from weightKg to weightValue
      const orderItems = cart.map(item => ({
        productId: item.id,
        name: item.name,
        price: item.price,
        qty: item.quantity,
        variant: item.variantLabel,
        weight: item.weightValue   // ✅ "10kg", "20kg", "1kg"
      }));
